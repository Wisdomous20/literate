...
export function WelcomeSection({
  ...
  return (
    <div className="relative min-h-45 overflow-hidden rounded-2xl border border-[#DED7FF] bg-[linear-gradient(135deg,#FFFFFF_0%,#F8F6FF_48%,#F1F5FF_100%)] shadow-[0_14px_40px_rgba(76,59,171,0.09)] font-poppins">
      ...
      <div className="relative z-10 min-h-45 px-5 py-6 md:px-8 md:pr-[250px] lg:pr-[300px]">
        <div className="max-w-[540px]">
          <p className="mb-2 text-xs font-semibold uppercase tracking-[0.18em] text-[#6C4EEB]">
            School Year {schoolYear}
          </p>
          <h2 className="text-2xl font-bold leading-tight tracking-tight text-[#323743] md:text-3xl">
            Reading assessment workspace
          </h2>
          <p className="mt-3 max-w-lg text-sm leading-6 text-[#575E6B]">
