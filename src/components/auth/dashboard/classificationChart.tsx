...
export function ClassificationChart() {
  ...
  // Server snapshot: false, client snapshot: true (hydration-safe)
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="relative">
            <button
              ...
              className="flex min-w-40 items-center justify-between gap-2 rounded-lg border border-[#5D5DFB]/30 bg-white px-3 py-2 text-sm font-medium text-[#00306E] transition-colors hover:bg-[#E4F4FF]"
            >
