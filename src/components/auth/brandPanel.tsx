      ...
      <div className="flex flex-col items-center gap-6">
        <div className="relative">
          ...
          >
            ...
            {/* Open book pages */}
            <path
              d="M30 60L60 85L60 105L25 80V60H30Z"
              fill="white"
            />
            <path
              d="M90 60L60 85L60 105L95 80V60H90Z"
              fill="white"
            />
            {/* Book spine */}
            <rect x="55" y="85" width="10" height="20" fill="white" opacity="0.8" />
          </svg>
        </div>
        <h1 className="text-4xl font-bold text-white tracking-wide">LiteRate</h1>
      </div>
    </div>
  )
}