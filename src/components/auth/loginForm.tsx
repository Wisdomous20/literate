    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/auth/forgot-password" className="text-sm text-[#162db0] hover:underline font-medium">
            Forgot password?
          </Link>
        </div>
      </div>
      ...
      <p className="text-center text-sm text-[#040029]">
        ...
        <Link href="/auth/signup" className="text-[#162db0] hover:underline font-medium">
          Sign up
        </Link>
      </p>
    </form>
