...
export default function Footer() {
  return (
    <footer className="overflow-hidden bg-[#F3F1FD] pb-7 md:pb-8">
      <div className="grid grid-cols-1 gap-8 border-t border-[#E0E2E6] px-5 pt-9 md:mb-12 md:grid-cols-2 md:gap-10 md:px-12 md:pt-12 lg:grid-cols-2">
        {/* Brand */}
        <div className="flex items-center gap-4">
          ...
          />
          <div>
            <span className="block mb-1 text-xl font-bold text-[#6C4EEB] md:font-['Outfit']">
              LiteRate
            </span>
            <p className="text-sm leading-relaxed text-[#575E6B]">
