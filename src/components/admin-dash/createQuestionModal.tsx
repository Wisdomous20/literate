...
export function CreateQuestionModal({
  ...
  const handleSubmit = useCallback(
    ...
    [questionText, passageId, tags, type, options, correctAnswer, onCreateQuestion, onClose]
  )
  ...
  const modalContent = (
    <div className="fixed inset-0 flex items-center justify-center" style={{ zIndex: 99999 }}>
      ...
      <div className="relative animate-in fade-in zoom-in-95 duration-300">
        <div
          className="w-[640px] max-h-[90vh] overflow-auto bg-white p-8"
          style={{
            borderRadius: "30px",
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="mt-1 text-base text-[#00306E]/70">
              Create a comprehension question for a passage quiz
            </p>
          </div>
