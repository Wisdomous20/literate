  ...
  return (
    <div>
      <div className="max-w-xl mx-auto bg-white rounded-2xl shadow-lg p-8 border border-[#E4F4FF]">
        ...
        {question.type === "ESSAY" && (
          <div className="mb-2">
            <span className="font-semibold text-[#00306E]">
              Expected Answer / Key Points:
            </span>
            <div className="mt-1 text-green-700 bg-green-50 border border-green-200 rounded-lg p-2 whitespace-pre-wrap font-medium">
              {question.correctAnswer || <span className="text-gray-400">No key points provided.</span>}
            </div>
          </div>
        )}
