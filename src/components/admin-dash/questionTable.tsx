...
export function QuestionTable({
  ...
  return (
    <div className="flex flex-1 flex-col">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 rounded-lg border border-[#5D5DFB]/20 bg-white px-4 py-2.5 text-sm font-medium text-[#00306E] hover:bg-[#E4F4FF]"
            >
              <span>{tagFilter === "all" ? "Tags" : tagFilter}</span>
              <ChevronDown className="h-4 w-4" />
            </button>
                ...
                {(["all", "Literal", "Inferential", "Critical"] as const).map(
                  (t) => (
                    <button
                      ...
                      className={`w-full px-4 py-2 text-left text-sm hover:bg-[#E4F4FF] ${
                        tagFilter === t
      ...
      >
        {/* Header */}
        <div className="grid grid-cols-[2.5fr_1.5fr_1fr_1fr_1fr_1fr_100px] px-6 py-3 bg-[rgba(74,74,252,0.12)]">
        ...
        <div className="divide-y divide-[rgba(74,74,252,0.08)]">
          {paginatedQuestions.map((question) => (
            <div
              key={question.id}
              className="grid grid-cols-[2.5fr_1.5fr_1fr_1fr_1fr_1fr_100px] items-center px-6 py-3.5"
            >
              <span className="truncate pr-4 text-sm font-medium text-[#00306E]">
                {question.questionText}
              </span>
              ...
              <div className="flex items-center justify-end gap-2">
                <button
                  ...
                  className="text-[#54A4FF] hover:opacity-70"
                  title="View"
                >
                ...
                <button
                  onClick={() => onDelete(question.id)}
                  className="text-[#DE3B40] hover:opacity-70"
                  title="Delete"
                >
                  <Trash2 className="h-4 w-4" />
                </button>
