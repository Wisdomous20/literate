      ...
      <main className="flex-1 flex flex-col gap-6 px-4 sm:px-6 lg:px-8 py-6 min-h-0 overflow-y-auto">
        ...
        <div className="rounded-3xl bg-gradient-to-r from-[#E8E5FF]/70 via-[#F0ECFF]/70 to-[#F8F6FF]/70 p-6 border border-[#B8B3FF]/25 shadow-[0_4px_20px_rgba(102,102,255,0.1)] backdrop-blur-sm">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full lg:w-auto">
              {/* Search Input - LARGER */}
              <div className="flex items-center gap-3 rounded-2xl border border-[#9999FF]/40 bg-white/90 px-5 py-3 shadow-[0_4px_16px_rgba(102,102,255,0.12)] backdrop-blur-sm flex-1 sm:flex-none transition-all hover:shadow-[0_6px_20px_rgba(102,102,255,0.15)]">
                <Search className="h-5 w-5 text-[#6666FF]/70 shrink-0" />
                <input
                  type="text"
                  placeholder="Search students…"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="flex-1 bg-transparent text-base text-[#00306E] outline-none placeholder:text-[#00306E]/40 font-medium"
                />
              </div>
              ...
              <select
                ...
                className="rounded-xl border border-[#9999FF]/40 bg-white/90 px-4 py-3 text-sm font-bold text-[#6666FF] outline-none transition-all hover:bg-white hover:shadow-[0_4px_12px_rgba(102,102,255,0.15)] focus:border-[#6666FF]/50 focus:ring-1 focus:ring-[#6666FF]/20 shadow-[0_2px_8px_rgba(102,102,255,0.08)] backdrop-blur-sm"
                aria-label="Sort students"
                title="Sort students"
              >
                <option value="nameAsc">Name: A → Z</option>
              ...
              <button
                onClick={() => setIsModalOpen(true)}
                type="button"
                className="rounded-xl border border-[#7A7AFB] bg-gradient-to-r from-[#6666FF] via-[#7270FF] to-[#7A7AFB] px-5 py-3 text-sm font-bold text-white shadow-[0_4px_16px_rgba(102,102,255,0.3)] transition-all hover:shadow-[0_8px_24px_rgba(102,102,255,0.4)] active:scale-95 whitespace-nowrap"
              >
                + Create Student
              </button>
            </div>
